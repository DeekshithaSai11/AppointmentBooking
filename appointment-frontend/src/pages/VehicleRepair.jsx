    ...
    <div className="min-h-screen bg-gray-50/50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 fade-in">
          ...
          <h1 className="text-5xl font-extrabold text-gray-900 tracking-tight mb-6">Vehicle Repair</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 w-full fade-in" style={{ animationDelay: '0.1s' }}>
          {repairs.map(repair => (
            <div key={repair.id} className="bg-white rounded-[2rem] shadow-md hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 group flex flex-col">
              ...
              <div className="p-8 flex-grow flex flex-col items-center text-center">
                <h3 className="text-2xl font-bold text-gray-900 mb-3 tracking-tight group-hover:text-slate-700 transition-colors">{repair.name}</h3>
